...
set /p usbLetter= Set partiton pendrive:  likw  G: or W: whole letter with colon 
...
echo 1.1. USB partition: %usbLetter%
...
md R:\RecoveryImage
copy %usbLetter%\sources\install.esd R:\RecoveryImage\install.esd
...
copy W:\Windows\System32\Recovery\winre.esd T:\Recovery\WindowsRE\winre.esd
